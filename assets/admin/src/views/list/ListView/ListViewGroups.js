...
class ListViewGroups extends ListView {

    editItem(id, label, weight, value, description) {
        ...
        MySwal.fire({
            ...
            html: '<input type="text" id="label" class="swal2-input" value="' + label + '" placeholder="megnevezés">' +
                '<input type="text" id="value" class="swal2-input" value="' + value + '" placeholder="érték" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
    ...
    addItem(e) {
        ...
        MySwal.fire({
            ...
            html: '<input type="text" id="label" class="swal2-input" placeholder="megnevezés">' +
                '<input type="text" id="value" class="swal2-input" placeholder="érték" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                                                        ...
                                                        <ButtonGroup variant="outlined" size="small" color="primary"
                                                            ...
                                                            <Button>
                                                                <EditIcon fontSize="small" color="primary"
                                                                          onClick={(event) => this.editItem(item.id, item.label, item.weight, item.value, item.description)}/>
                                                            </Button>
                                                            <Button>
