...
class ListViewPackages extends ListView {

    editItem(id, label, days, weight, stars, description) {
        ...
        MySwal.fire({
            ...
            html: '<input type="text" id="label" class="swal2-input" value="' + label + '" placeholder="megnevezés">' +
                ...
                '<input type="text" id="days" class="swal2-input" value="' + days + '" placeholder="napok" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                '<input type="text" id="stars" class="swal2-input" value="' + stars + '" placeholder="csillagok" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
            ...
            preConfirm: () => {
                ...
                const stars = Swal.getPopup().querySelector('#stars').value;
                const days = Swal.getPopup().querySelector('#days').value;
                const description = Swal.getPopup().querySelector('#description').value;

                if (!label || !weight || !days || !stars || !description) {
    ...
    addItem(e) {
        ...
        MySwal.fire({
            ...
            html: '<input type="text" id="label" class="swal2-input" placeholder="megnevezés">' +
                ...
                '<input type="text" id="days" class="swal2-input" placeholder="napok" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                '<input type="text" id="stars" class="swal2-input" placeholder="csillagok" onkeypress="return event.charCode >= 48 && event.charCode <= 57">' +
                                        ...
                                        <TableBody>
                                            {this.state.data.slice(this.state.limit.min, this.state.limit.max).map((item, index) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="center">
                                                        <Switch
                                                            onChange={(event) => this.handlePublicSwitchChange(event, index, item.id)}
                                                            color="primary"
                                                            checked={item.public}
                                                        ...
                                                        <ButtonGroup variant="outlined" size="small" color="primary"
                                                            ...
                                                            <Button>
                                                                <EditIcon fontSize="small" color="primary"
                                                                          onClick={(event) => this.editItem(item.id, item.label, item.days, item.weight, item.stars, item.description)}/>
                                                            </Button>
                                                            <Button>
...
export default ListViewPackages;
